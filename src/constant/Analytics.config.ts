...
import { detectAircraft, detectShip, detectTree, type UploadProgressHandler } from "../features/data/components/sidebar/api/Analytics.service";
...
export const serviceLabel = (name: DetectionType) =>
    SERVICE_BY_NAME.get(name)?.label ?? name;
