...
export { LAYER_ID, KEEPER_LAYER_ID, FALLBACK_SOURCE_ID, FALLBACK_TILE_URL, DEFAULT_FLOOR_HEIGHT, DEFAULT_HEIGHT, MIN_EXTRUSION, REBUILD_INTERVAL_MS, ANCHOR_RESET_METERS, CACHE_GRACE_PASSES }
