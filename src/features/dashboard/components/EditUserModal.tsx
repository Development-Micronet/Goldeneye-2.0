...
export const EditUserModal: React.FC<EditUserModalProps> = ({ open, onClose, user, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="border-gray-150 relative flex max-h-[90vh] w-full max-w-lg flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
        {/* Modal Header */}
        ...
        <form onSubmit={handleSubmit} className="flex-1 space-y-4 overflow-y-auto p-6">
          ...
          <div>
            ...
            <input
              ...
              readOnly
              required
              className="h-10 w-full cursor-not-allowed rounded-lg border border-gray-200 bg-gray-100 px-3 text-sm text-gray-500 focus:outline-none"
            />
          </div>
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-gray-700">Tenant Role</label>
            <select
              name="tenant_role"
          ...
          <div className="flex justify-end gap-3 border-t border-gray-100 pt-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="cursor-pointer rounded-lg bg-teal-700 px-4 py-2 text-sm font-medium text-white transition hover:bg-teal-800 disabled:opacity-50"
            >
