            ...
            <div className="w-full max-w-sm rounded-lg bg-white p-5 shadow-xl">
                ...
                <div className="flex justify-end gap-2">
                    ...
                    <button
                        ...
                        className={`rounded-md px-3 py-1.5 text-xs font-semibold text-white ${isAssign ? "bg-blue-600 hover:bg-blue-700" : "bg-red-600 hover:bg-red-700"
                            } disabled:opacity-50`}
                    >
                        {mutation.isPending ? "Processing..." : isAssign ? "Assign" : "Unassign"}
                    </button>
                </div>
            </div>
        </div>
