...
export const ResetPasswordPage: React.FC = () => {
    ...
    return (
        <div className="flex min-h-screen w-full items-center justify-center bg-gray-50 font-sans px-4">
            <div className="flex w-full max-w-[420px] flex-col py-8 bg-white px-6 rounded-xl shadow-lg border border-gray-100">
                {/* Logo */}
                ...
                <p className="mb-6 text-center text-xs text-gray-500 leading-relaxed">
